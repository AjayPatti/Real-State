...
$url = 'abr_receipt.php?search=Search';
...
if(isset($_POST['save'])){
	...
	$project = filter_post($conn,$_POST['project']);
	$block = filter_post($conn,$_POST['block']);
	$plot_number = filter_post($conn,$_POST['plot_number']);
	...
	$associate_id = (isset($_POST['associate']) && $_POST['associate'] != '')?filter_post($conn,$_POST['associate']):0;
	...
	if($name_title == ''){
	  ...
	  $_SESSION['error'] = 'Email was wrong!';
		...
		if(isset($already_exits['id'])){
			...
			mysqli_query($conn,"insert into kc_abr_receipt set name_title = '$name_title', name = '$name', parent_name = '$parent_name', parent_name_relation = '$parent_name_relation', nationality = '$nationality', email = '$email', mobile = '$mobile', dob = '$dob', address = '$address',amount = '$amount', payment_type = '$payment_type', paid_amount = '$paid_amount',paid_date = '$paid_date',remarks = '$remarks',next_due_date = '$next_due_date',sales_person_id = '$sales_person_id',associate_id = '$associate_id',associate_percentage = '$associate_percentage',project = '$project', block = '$block', plot_number = '$plot_number', area = '$area',send_message = '$send_message',status = '1', addedon =NOW(), added_by = '".$_SESSION['login_id']."' ");
		}
			$add = mysqli_insert_id($conn);
			if($add > 0){
				$_SESSION['success'] = 'Information Successfully Added!';
				header("location:abr_receipt.php");
				exit();
			}else{
...
if(isset($_POST['ab_save'])){
	...
	/******* comment due to mohit sir ask on 04062020 **********/
		...
		if(isset($_POST['ab_plc']) && is_array($_POST['ab_plc']) && sizeof($_POST['ab_plc']) > 0){
			foreach($_POST['ab_plc'] as $plc_id){
				...
				if(isset($plc_details['id'])){
					if(!mysqli_query($conn,"insert into kc_customer_block_plc set customer_block_id = '$customer_block_id', plc_id = '".$plc_details['id']."', name = '".$plc_details['name']."', 	plc_percentage = '".$plc_details['plc_percentage']."', status = '1', addedon =NOW() ")){
						$error = true;
		...
		if(!mysqli_query($conn,"insert into kc_customer_transactions set customer_id = '$customer_id', block_id = '$block', block_number_id = '$block_number', amount = '$payable_amount', cr_dr = 'cr', next_due_date = '$next_due_date', status = '1', addedon =NOW(), added_by = '".$_SESSION['login_id']."' ")){
			$error = true;
			//echo("Error description: " . mysqli_error($conn)); die;
		}
	//	echo $error;
		if($paid_amount > 0 && $paid_date != '' && $paid_date != '1970-01-01'){
			if(!mysqli_query($conn,"insert into kc_customer_transactions set customer_id = '$customer_id', block_id = '$block', block_number_id = '$block_number', payment_type = '$payment_type', bank_name = '$bank_name', cheque_dd_number = '$cheque_dd_number', amount = '$paid_amount', cr_dr = 'dr', paid_date = '$paid_date', add_transaction_remarks = '$add_transaction_remarks', next_due_date = '$next_due_date', status = '1', addedon =NOW(), added_by = '".$_SESSION['login_id']."' ")){
				$error = true;
				//echo("Error description: " . mysqli_error($conn));
			}else{
		...
		if(!$error && $customer_payment_type == "EMI"){
			for($i = 0; $i < $number_of_installment; $i++){
				...
				if(!mysqli_query($conn,"insert into kc_customer_emi set customer_id = '$customer_id', block_id = '$block', block_number_id = '$block_number', emi_amount = '$installment_amount', emi_date = '$emi_payment_date', created = NOW() ")){
					$error = true;
					//echo("Error description: " . mysqli_error($conn)); die;
				}
			}
...
if(isset($_POST['addTransaction'])){
	...
	if(!($id > 0)){
		...
		$abr_row = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM kc_abr_receipt where id = '".$id."'"));
		echo "INSERT INTO kc_abr_receipt SET name_title = '".$abr_row['name_title']."', name = '".$abr_row['name']."', parent_name = '".$abr_row['parent_name']."', parent_name_relation = '".$abr_row['parent_name_relation']."', nationality = '".$abr_row['nationality']."', email = '".$abr_row['email']."', mobile = '".$abr_row['mobile']."', dob = '".$abr_row['dob']."', address = '".$abr_row['address']."', payment_type = '$payment_type', paid_amount = '$paid_amount',paid_date = '$paid_date',remarks = '$remarks',next_due_date = '$next_due_date',sales_person_id = '".$abr_row['sales_person_id']."',associate_id = '".$abr_row['associate_id']."',associate_percentage = '".$abr_row['associate_percentage']."',send_message = '$send_message',status = '1', addedon =NOW(), added_by = '".$_SESSION['login_id']."' "; die();
		mysqli_query($conn,"INSERT INTO kc_abr_receipt SET name_title = '".$abr_row['name_title']."', name = '".$abr_row['name']."', parent_name = '".$abr_row['parent_name']."', parent_name_relation = '".$abr_row['parent_name_relation']."', nationality = '".$abr_row['nationality']."', email = '".$abr_row['email']."', mobile = '".$abr_row['mobile']."', dob = '".$abr_row['dob']."', address = '".$abr_row['address']."', payment_type = '$payment_type', paid_amount = '$paid_amount',paid_date = '$paid_date',remarks = '$remarks',next_due_date = '$next_due_date',sales_person_id = '".$abr_row['sales_person_id']."',associate_id = '".$abr_row['associate_id']."',associate_percentage = '".$abr_row['associate_percentage']."',send_message = '$send_message',status = '1', addedon =NOW(), added_by = '".$_SESSION['login_id']."' ");
	}
}
...
if(isset($_POST['editInformation'])){
	...
	if(!($id > 0) || !is_numeric($id)){
	  ...
	  $_SESSION['error'] = 'Email was wrong!';
		...
		$already_exits = mysqli_fetch_assoc(mysqli_query($conn,"select id from kc_abr_receipt where id != '$id' and (email = '".$email."' or mobile = '$mobile') limit 0,1 "));
		if(isset($already_exits['id'])){
			$_SESSION['error'] = 'Email or Mobile Already Exists!';
		}else{
			mysqli_query($conn,"update kc_abr_receipt set name_title = '$name_title', name = '$name', parent_name = '$parent_name', parent_name_relation = '$parent_name_relation', nationality = '$nationality', email = '$email', mobile = '$mobile', dob = '$dob', address = '$address' where id = '$id' ");

			$name_with_title = $name_title.' '.$name;
			mysqli_query($conn,"update kc_abr_receipt set name = '$name_with_title', mobile = '$mobile', addedon = '".$_SESSION['login_id']."' where id = '$id' limit 1 ");
...
if(isset($_POST['changeBlockNumber'])){
	...
	if($block_number_id == $changed_block_number_id){
		...
		if (!$error && !mysqli_query($conn,"insert into kc_customer_transactions_hist (kc_customer_transactions_id, customer_id, block_id, block_number_id, payment_type, bank_name, cheque_dd_number, amount, cr_dr, paid_date, next_due_date, late_for_transaction_id, is_affect_sold_amount, status, remarks, add_transaction_remarks, action_type, addedon, added_by, deleted_by) select id, customer_id, block_id, block_number_id, payment_type, bank_name, cheque_dd_number, amount, cr_dr, paid_date, next_due_date, late_for_transaction_id, is_affect_sold_amount, status, remarks, add_transaction_remarks, 'Plot Number Changed', addedon, added_by, '".$_SESSION['login_id']."' from kc_customer_transactions where customer_id = '$customer_id' and block_id = '$block_id' and block_number_id = '$block_number_id';")){
			$error = true;
			echo("Error description: " . mysqli_error($conn)); die;
		}
		...
		if(!$error && isset($_POST['plc']) && is_array($_POST['plc']) && sizeof($_POST['plc']) > 0){
			foreach($_POST['plc'] as $plc_id){
				...
				if(isset($plc_details['id'])){
					if(!mysqli_query($conn,"insert into kc_customer_block_plc set customer_block_id = '".$customer_block_details['id']."', plc_id = '".$plc_details['id']."', name = '".$plc_details['name']."', 	plc_percentage = '".$plc_details['plc_percentage']."', status = '1', addedon =NOW() ")){
						$error = true;
						echo("Error description: " . mysqli_error($conn)); die;
					}else{
...
if(isset($_POST['addLatePayment'])){
	...
	if(!isset($customer_details['id'])){
		...
		$error = false;
		mysqli_autocommit($conn,FALSE);
		//echo "insert into kc_customer_transactions set customer_id = '$customer_id', block_id = '$block_id', block_number_id = '$block_number_id', amount = '$late_amount', cr_dr = 'cr', paid_date = '".date("Y-m-d")."', next_due_date = '$next_due_date', remarks = '$late_remarks', status = '1', addedon =NOW(), added_by = '".$_SESSION['login_id']."' "; die;
		if(!mysqli_query($conn,"insert into kc_customer_transactions set customer_id = '$customer_id', block_id = '$block_id', block_number_id = '$block_number_id', amount = '$late_amount', cr_dr = 'cr', paid_date = '".date("Y-m-d")."', next_due_date = '$next_due_date', late_for_transaction_id = '$latestTransactionID', remarks = '$late_remarks', status = '1', addedon =NOW(), added_by = '".$_SESSION['login_id']."' ")){
			$error = true;
			//echo("Error description: " . mysqli_error($conn)); die;
		}
...
if(isset($_POST['cancelTransaction'])){
	...
	if(!isset($transaction_details['id'])){
		...
		if (!mysqli_query($conn,"insert into kc_customer_transactions_hist (kc_customer_transactions_id, customer_id, block_id, block_number_id, payment_type, bank_name, cheque_dd_number, amount, cr_dr, paid_date, next_due_date, late_for_transaction_id, is_affect_sold_amount, status, remarks, add_transaction_remarks, cancel_remarks, action_type, addedon, added_by, deleted_by) select id, customer_id, block_id, block_number_id, payment_type, bank_name, cheque_dd_number, amount, cr_dr, paid_date, next_due_date, late_for_transaction_id, is_affect_sold_amount, status, remarks, add_transaction_remarks, '$cancel_remarks', 'Payment Cancelled', addedon, added_by, '".$_SESSION['login_id']."' from kc_customer_transactions where id = '$transaction_id';")){
			$error = true;
			echo("Error description: " . mysqli_error($conn)); die;
		}
...
if(isset($_GET['id']))
{
  // $del = $_POST['delete'];
  $id = $_GET['id'];
  $del = "update `kc_abr_receipt` set deleted= '".date('Y-m-d H:i:s')."' WHERE id=$id";
...
@media screen and (min-width: 768px) {
  ...
  <body class="skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">ABR Receipt</li>
          </ol>
        </section>
        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
					...
					<div class="row">
						<div class="col-sm-8">
							<h3 class="box-title">All ABR Receipt Information</h3>
						</div>
	                    <div class="col-sm-4">
							<button class="btn btn-sm btn-success pull-right" data-toggle="modal" data-target="#addAbrReceipt">Add ABR Receipt</button>
						</div>
					</div>
					<hr />
				</div>
                <div class="box-body no-padding">
                	<div class="table-responsive">
					 <table class="table table-striped table-hover table-bordered">
						...
						<?php
						$query = "select * from kc_abr_receipt where status = '1' and deleted is null ";
							...
							while($receipt = mysqli_fetch_assoc($receipts)){
								...
								<tr>
									...
									<td nowrap="nowrap">
	                                    ...
	                                    <strong><?php echo $receipt['parent_name_relation']; ?></strong> <?php if($receipt['parent_name'] != ''){ ?>of <strong><?php echo $receipt['parent_name']; } ?></strong><br>

									</td>
									<td>
										Email: <strong><?php echo $receipt['email']; ?></strong><br>
	                                    Mobile: <strong><?php echo $receipt['mobile']; ?></strong><br>
									...
									<td>
										...
										Amount: <strong class="text-primary"><?php echo $receipt['amount']; ?></strong><br>
									...
									<td>
										<strong class="text-danger"><?php echo $receipt['project']; ?></strong><br>
										<strong class="text-danger"><?php echo $receipt['block'].'('.$receipt['plot_number'].','.$receipt['area'].')'; ?></strong><br>
										
									</td>
									<td><?php echo $receipt['remarks']; ?></td>
									<td><?php echo date('jS M Y',strtotime($receipt['addedon'])); ?></td>
									<td nowrap="nowrap">
	                                	<button class="btn btn-xs btn-info" type="button" data-toggle="tooltip" title="View ABR Receipt Information" onclick = "viewInformation(<?php echo $receipt['id']; ?>);"><i class="fa fa-eye"></i></button>
	                                	<button class="btn btn-xs btn-warning" type="button" data-toggle="tooltip" title="Edit ABR Receipt Information" onclick = "editInformation(<?php echo $receipt['id']; ?>);"><i class="fa fa-pencil"></i></button>
	                                	<a href="abr_receipt.php?id=<?php echo $receipt['id']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure');"><i class="fa fa-trash "></i></a>
									</td>
								</tr>
								<?php
								$counter++;
	...
	<div class="modal" id="addAbrReceipt">
	  <div class="modal-dialog">
		<div class="modal-content">
			<form action="abr_receipt.php" name="" id="" method="post" class="form-horizontal">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">Add ABR Receipt</h4>
			  </div>
			  <div class="modal-body">
				<div class="box box-info">
					<div class="box-header with-border">
						<div class="col-md-12">
							<h3 class="box-title">Add ABR Receipt Panel</h3>
						</div>
					</div><!-- /.box-header -->
					<!-- form start -->
					<div class="box-body">
                        ...
                        <div class="form-group">
						  <label for="block_number" class="col-sm-3 control-label">Plot Number</label>
						  <div class="col-sm-8">
							<input type="text" name="plot_number" class="form-control" id="plot_number">
						  </div>
						</div>
                        
                        <div class="form-group">
						  <label for="area" class="col-sm-3 control-label">Total Area</label>
						  <div class="col-sm-8">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-8">
							<input type="amount" class="form-control" id="amount" name="amount" data-validation="amount" data-validation-optional="true">
						  </div>
						</div>
						...
						<div class="form-group">
						  <label for="sales_person" class="col-sm-3 control-label">Associate</label>
						  <div class="col-sm-8">
    ...
    <div class="modal" id="editInformation">
	  <div class="modal-dialog">
		<div class="modal-content">
			<form enctype="multipart/form-data" action="abr_receipt.php" name="edit_frm" id="edit_frm" method="post" class="form-horizontal dropzone">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	...
	<div class="modal" id="viewInformation">
	  <div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">ABR Receipt Information</h4>
			</div>
			<div class="modal-body">
				<div class="box box-info">
