        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
					...
					<div class="col-sm-10">
						<h3 class="box-title">All Registry</h3>
					</div>
					  ...
					  <ul class="pagination pagination-sm no-margin pull-right">
						...
						<?php
							for($i = 1; $i <= $total_pages; $i++){
								?>
								 <li <?php if((isset($_GET['page']) && $i == $_GET['page']) || (!isset($_GET['page']) && $i == 1)){ ?>class="active"<?php } ?>><a href="registries.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
								<?php
							}
						?>
