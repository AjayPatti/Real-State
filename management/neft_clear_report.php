      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Clear Neft Report</li>
          </ol>
        </section>
        ...
        <section class="content">
			<div class="box">
                <div class="box-header">
					...
					<div class="col-sm-10">
						<h3 class="box-title">Clear Neft Report</h3>
					</div>
					<div class="col-sm-1">
							<a href="neft_clear_report_excel.php" class="btn btn-sm btn-success pull-right"><i class="fa fa-file-excel-o"></i> Excel Export</a>
					</div>
					<!-- <div class="col-sm-1">
                ...
                <div class="box-body no-padding" id="printContent">
				 <div class="table-responsive">
					 <table class="table table-striped table-hover table-bordered">
						...
						$total_records = mysqli_fetch_assoc(mysqli_query($conn,"select COUNT(*) as total from kc_customer_transactions where status = '1' and payment_type  = 'NEFT' AND clear_remarks is not null "));
					  ...
					  <ul class="pagination pagination-sm no-margin pull-right">
						...
						<?php
							for($i = 1; $i <= $total_pages; $i++){
								?>
								 <li <?php if((isset($_GET['page']) && $i == $_GET['page']) || (!isset($_GET['page']) && $i == 1)){ ?>class="active"<?php } ?>><a href="neft_clear_report.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
								<?php
							}
						?>
