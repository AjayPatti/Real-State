...
if(!isset($_POST['account_id']) || !is_numeric($_POST['account_id']) || !($_POST['account_id'] > 0)){
	exit();
}
...
$credit = 0;
$transactions = mysqli_query($conn,"select * from  kc_customer_transactions where account_id = '".$_POST['account_id']."' and status = '1' ");
