...
<div class="form-group">
  ...
  <div class="col-sm-8">
  <input type="text" class="form-control" readonly id="code" name="code" maxlength="255" required value="<?php echo isset($associate_details['code'])?$associate_details['code']:''; ?>" />
...
<div class="form-group">
  ...
  <div class="col-sm-8">
  <input type="text" class="form-control" id="name" readonly name="name" maxlength="255" required value="<?php echo isset($associate_details['name'])?$associate_details['name']:''; ?>" />
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-8">
  <input type="text" class="form-control" readonly id="mobile" name="mobile" maxlength="255" required value="<?php echo isset($associate_details['mobile_no'])?$associate_details['mobile_no']:''; ?>" />
  </div>
</div>